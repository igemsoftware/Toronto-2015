...
Subsystem = (function() {
  function Subsystem(attr) {
    ...
    (parsors[this.type].parser.bind(this))();
  }
  ...
  Subsystem.prototype.parseData = function() {
    return parsors[this.type].parser();
  };
...
module.exports = {
  species: {
    parser: function() {
      ...
      return this.parsedData.push('data');
    },
    sortor: function() {
