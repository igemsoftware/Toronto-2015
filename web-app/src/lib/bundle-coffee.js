...
Subsystem = (function() {
  ...
  Subsystem.prototype.buildSystem = function(data) {
  ...
  Subsystem.prototype.parseData = function(compartmentor, sortor) {
...
var Network, System, TreeNode, network, sortables, systemAttributes;
